...
/// Hauptmenü (Mockup 5.1): Level/XP oben, grosse Aktions-Buttons, letzte Läufe.
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  /// Öffnet einen Screen und lädt danach neu (XP/Läufe können sich geändert haben).
  ...
  Widget _buildSprintButton() {
    return ElevatedButton.icon(
      onPressed: () => _openThenReload(const TrackListScreen()),
      ...
      children: [
        Expanded(
          child: _secondaryButton(
            ...
            label: 'STRECKE\nVERMESSEN',
            onPressed: () => _openThenReload(const MeasureScreen()),
          ),
        ),
        ...
        Expanded(
          child: _secondaryButton(
            ...
            label: 'STATISTIK',
            onPressed: () => _openThenReload(const StatsScreen()),
          ),
        ),
      ],
    );
